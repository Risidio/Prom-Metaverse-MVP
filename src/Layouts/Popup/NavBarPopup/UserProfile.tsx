  ...
  return (
    <article className='user'>
      <nav className='user__top'>
        <h1 className='user__top-tile'>Your profile</h1>
      ...
      <section className='user__main'>
        <div className='user__left'>
          ...
          <ul className='user__left-list'>
            {roles.map((role) => {
              return <li className='user__left-item'>{role}</li>;
            })}
          </ul>
      ...
      {showProfileChange && (
        <ProfileSettings closeModal={handleProfileSettings}></ProfileSettings>
      )}
