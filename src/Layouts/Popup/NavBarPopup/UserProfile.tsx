  ...
  return (
    <article className="user">
      <nav className="user__top">
        ...
        <button className="user__top-close"
          type="button"
          onClick={closeModal}>
      ...
      <section className="user__main">
        <div className="user__left">
          <h1 className="user__left-title">
            {userName} <span className="user__left-title--pronoun">{pronouns}</span>
          </h1>

          <ul className="user__left-list">
            {roles.map((role) => {
              return (
                <li className="user__left-item">
                  {role}
                </li>
              )
            })}
        ...
        <div className="user__right">
          <div className="user__right-button-container">
            {redButtonsArrayText.map(text => {
              return (
                <RedButton text={text}
                  className="button--user-right"></RedButton>
              )
            })}
            <button>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="26" height="26" rx="8" fill="#30374D" />
                <path d="M5 13C5 13.2546 5.10114 13.4988 5.28118 13.6788C5.46121 13.8589 5.70539 13.96 5.96 13.96H12.04V20.04C12.04 20.2946 12.1411 20.5388 12.3212 20.7188C12.5012 20.8989 12.7454 21 13 21C13.2546 21 13.4988 20.8989 13.6788 20.7188C13.8589 20.5388 13.96 20.2946 13.96 20.04V13.96H20.04C20.2946 13.96 20.5388 13.8589 20.7188 13.6788C20.8989 13.4988 21 13.2546 21 13C21 12.7454 20.8989 12.5012 20.7188 12.3212C20.5388 12.1411 20.2946 12.04 20.04 12.04H13.96V5.96C13.96 5.70539 13.8589 5.46121 13.6788 5.28118C13.4988 5.10114 13.2546 5 13 5C12.7454 5 12.5012 5.10114 12.3212 5.28118C12.1411 5.46121 12.04 5.70539 12.04 5.96V12.04H5.96C5.70539 12.04 5.46121 12.1411 5.28118 12.3212C5.10114 12.5012 5 12.7454 5 13Z" fill="white" />
              </svg>
