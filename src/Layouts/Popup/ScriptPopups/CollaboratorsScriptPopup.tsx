...
const CollaboratorsScriptPopup: React.FC<Props> = ({
  searchInput,
  searchInputChange,
  collaborators,
}) => {
  return (
    <section className="script__collaborator">
      <div className="contact__form-search-container
      script__collaborator-search">
        <input type="text"
        ...
        {collaborators.map((collaborator) => {
          return (
            <div className="script__collaborator-card">
              ...
              type="button"
              className="script__collaborator-card-button"></WhiteButton>
            </div>
          )
        })}
      </div>
...
export default CollaboratorsScriptPopup;