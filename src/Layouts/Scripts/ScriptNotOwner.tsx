      ...
      <section className="script__main">
        <div className="script__left">
          <h1 className="script__left-title">
            {script.title} {' '}
            <span className="script__left-title--author">
          ...
          <ul className="script__left-list">
            ...
            <li className="script__left-item">
              {script.pagesAmount} pages
            </li>
          </ul>


          <div className="script__left-img
          ...
          <section className="script__right-reviews">
            ...
            {script.privacy === 'private script' ? (
              <p className="script__right-reviews-info">
                You need <span className="decoration-solid">script access</span> to add a review
              </p>
              ...
              script.reviews?.length === 0
                ? (
                  <p className="script__right-reviews-info">
                    No reviews yet! {' '}<span className="decoration-solid">Be the first!</span>
                  </p>
                  ...
                  <div className="sript__right-reviews-card">
                    <div className="script__right-reviews-top">
                      ...
                      <WhiteButton className=""
                        text="Write Coverage"></WhiteButton>
                    </div>
