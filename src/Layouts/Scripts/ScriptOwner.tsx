...
const ScriptOwner: React.FC<Props> = ({
  movie,
  setMovie,
}) => {
  ...
  const handleRadioChange = (id: string) => {
    ...
    setMovie((prevMovie) => {
      const newPrivacy = id === "option1" ? "Public script" : "Shared upon request";
  ...
  return (
    ...
    <article className="script">
      ...
      <section className="script__main">
        <div className="script__left">
          ...
          <ul className="script__left-list">
            <li className="script__left-item">
              {movie.type}
            </li>
            ...
            <li className="script__left-item">
              {movie.pagesAmount} pages
            </li>
          </ul>


          <div className="script__left-img"></div>
        ...
        <div className="script__right">
          ...
          <div className="script__right-header">
            ...
            <div className="script__right-button-container">
              <WhiteButton text="Share"
                className="script__right-button--share"
                onClick={handleShareClick}></WhiteButton>

              <button type="button">
                <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.5" y="0.5" width="50" height="50" rx="25" stroke="#B6BAC4" />
                  <path d="M13.0757 38.5945V32.7364L30.8807 14.5763C31.1505 14.3236 31.4486 14.1283 31.775 13.9904C32.1015 13.8526 32.4441 13.7837 32.8029 13.7837C33.1626 13.7837 33.511 13.8526 33.8482 13.9904C34.1855 14.1283 34.4777 14.335 34.725 14.6107L36.5797 16.5404C36.8495 16.7932 37.0464 17.0918 37.1705 17.4364C37.2946 17.781 37.3562 18.1256 37.3553 18.4702C37.3553 18.8377 37.2937 19.1883 37.1705 19.5219C37.0473 19.8554 36.8504 20.1596 36.5797 20.4344L18.8084 38.5945H13.0757ZM32.7691 20.3999L34.6576 18.4702L32.7691 16.5404L30.8807 18.4702L32.7691 20.3999Z" fill="#30374D" />
                </svg>
          ...
          {movie.privacy === "Public script" && selectedOption === 'option1' && (
            <div className="script__public">
              ...
              <div className="script__public-container">
                ...
                <div>
                  <p className="script__public-text script__public-text--rate">
                    3.01/5 <span className="script__public-text--votes">
                      123 votes
                    </span>
                  </p>
              ...
              <div className="script__public-container script__public-container--right">
                ...
                <svg width="24" height="34" viewBox="0 0 24 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 7.55556V34L12 26.4444L0 34V7.55556C0 5.5517 0.842854 3.62991 2.34315 2.21297C3.84344 0.796029 5.87827 0 8 0H16C18.1217 0 20.1566 0.796029 21.6569 2.21297C23.1571 3.62991 24 5.5517 24 7.55556Z" fill="#DC1720" />
                </svg>
          ...
          {movie.privacy === "Shared upon request" && selectedOption === 'option2' && (
            <div className="script__request">
              <p className="script__request-text">
                Shared with:
              </p>
          ...
          <div className="script__right-button-container mb-2">
            {movie.genres.map(genre => {
              return (
                <RedButton text={genre}
                  className="script__right-button"></RedButton>
              )
            })}
          </div>

          <h2 className="script__right-title">

            Contributors: {' '}
            {movie.cowriters.map((author) => {
              return (
                <>
                  <span className="script__right-title--underline">
                    {author}
                  </span> co-writer, {' '}
      ...
      {isModalOpen &&
        ...
        <ShareSettings toggleShare={handleToggleShare}
          isToggled={isToggled}
